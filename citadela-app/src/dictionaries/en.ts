...
export const en = {
  ...
  rentalTerms: {
    title: "Rental terms",
    lead: "These terms apply to everything hired from us — boat, paddleboards, scooters, bikes, motorcycles and cars. They are agreed at handover and the version you agreed to is recorded with the hire.",
    draftHeading: "Working draft",
    draftBody:
      "This document is not in force yet: the insurance cover is not arranged and the wording has not been through legal review. It is published so the operator and the reviewer are reading the same thing.",
    versionLabel: (version: string) => `Version ${version}`,
    requirementsHeading: "Who may take what",
    columns: { item: "Item", licence: "Licence", age: "Minimum age", deposit: "Deposit" },
    noDeposit: "none",
    noAge: "no limit",
    clausesHeading: "Terms",
    clauses: {
      handover: (from: string, by: string) =>
        `Handover from ${from}; everything is returned by ${by} on the agreed day.`,
      late: (amount: string) => `Late return is charged ${amount} for each hour begun.`,
      fuel: "Vehicles are handed over with a full tank and returned full; otherwise fuel is charged as used plus the trip to the pump.",
      helmet: "Helmets are provided and must be worn on motorcycles, scooters and bikes.",
      alcohol: "Zero alcohol and no drugs behind any wheel, tiller or handlebar. Breaking this ends the hire on the spot with no refund.",
      licence: "Licences and ID are checked at handover. Without them the item is not released and the hire is cancelled without charge.",
      boat: "The boat goes out either with a licence holder aboard or with our skipper. Life jackets are worn by everyone on board.",
      deposit: "The deposit is taken at handover and returned on the day of departure once the item comes back undamaged.",
      damage: "Damage, loss and third-party claims are settled against the deposit, and beyond it by the hirer.",
      insurance: (excess: string) => `Damage cover carries an excess of ${excess} per event.`,
      insuranceMissing:
        "Insurance cover is being arranged — the excess per event will be stated here before these terms come into force.",
      minors: "Nobody under the stated minimum age drives, rides or steers, supervised or not.",
      area: "Vehicles stay in Czechia and off closed courses, race tracks and private events.",
      breakdown: "Call us on a breakdown; do not arrange repairs yourself. We come, or we swap the item.",
    },
    contactHeading: "Questions",
    contactBody: "Ask before you book rather than at handover — anything unclear here is quicker to settle in advance.",
